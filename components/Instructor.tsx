                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <FadeIn delay={100} direction="right">
                        ...
                        <div className="space-y-6 text-gray-600 font-body text-lg mb-10">
                            <p>
                                <strong className="text-gray-900">GM Belleza</strong> es un centro de belleza integral liderado por profesionales certificadas y apasionadas. Su filosofía se basa en realzar tu estilo cuidando la salud de tus uñas y respetando a los animales.
                            </p>
                            <p>
