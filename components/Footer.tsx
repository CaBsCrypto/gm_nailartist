                    ...
                    <div className="md:col-span-2">
                        ...
                        <div className="flex gap-4">
                            <a
                                ...
                                className="w-20 h-20 rounded-full bg-amber-500/10 flex items-center justify-center text-amber-600 hover:bg-amber-500 hover:text-white transition-colors shadow-sm"
